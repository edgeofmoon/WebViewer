...
var three_marchingCubesRoi = function (roi, isolevel) {
    ...
    var bMax = roi.boundingbox.max;
    var bSizes = roi.boundingbox.size();
    var bSize = bSizes.x;
    var bSize2 = bSize * bSizes.y;
    ...
    for (var z = 0; z < bSizes.z - 1; z++)
        for (var y = 0; y < bSizes.y - 1; y++)
            for (var x = 0; x < bSizes.x - 1; x++) {
                // index of base point, and also adjacent points on cube
                var p = x + bSize * y + bSize2 * z,
                    px = p + 1,
                    py = p + bSize,
                    pxy = py + 1,
                    pz = p + bSize2,
